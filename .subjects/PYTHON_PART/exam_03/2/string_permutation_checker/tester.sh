...
spec = importlib.util.spec_from_file_location("ref", "string_permutation_checker.py")
mod = importlib.util.module_from_spec(spec)
spec.loader.exec_module(mod)
f = mod.string_permutation_checker
...
spec = importlib.util.spec_from_file_location("student", "../../rendu/string_permutation_checker/string_permutation_checker.py")
mod = importlib.util.module_from_spec(spec)
spec.loader.exec_module(mod)
f = mod.string_permutation_checker
