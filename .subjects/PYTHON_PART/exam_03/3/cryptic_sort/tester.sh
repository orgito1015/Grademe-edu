...
spec = importlib.util.spec_from_file_location("ref", "cryptic_sort.py")
mod = importlib.util.module_from_spec(spec)
spec.loader.exec_module(mod)
f = mod.cryptic_sort

tests = [
    (["A", "banana", "grape", "kiwi", "oArange"],),
    (["a", "e", "b", "o", "u"],),
    (["Arsen", "arsen", "ARSEN"],),
    (["aaa", "AAA", "bbb", "BBB"],),
    ([],),
...
spec = importlib.util.spec_from_file_location("student", "../../rendu/cryptic_sort/cryptic_sort.py")
mod = importlib.util.module_from_spec(spec)
spec.loader.exec_module(mod)
f = mod.cryptic_sort
